  ...
  <div class="layout">
    ...
    <aside class="dashboard-sidebar" id="sidebar">
      ...
      <nav class="sidebar-nav flex-grow-1">
        ...
        {{-- ==== User Management ==== --}}
        <div class="nav-group">
          <a href="#" class="nav-link group-toggle" data-target="usersMenu">
            <i class="fas fa-users-cog"></i><span>Users</span>
            <i class="fas fa-chevron-down ms-auto"></i>
          </a>
          <div id="usersMenu" class="submenu">

            <a href="/admin/student/manage"  class="nav-link">Students</a>

          </div>
        </div>
        {{-- ==== Exam Management ==== --}}
        <div class="nav-group">
          <a href="#" class="nav-link group-toggle" data-target="courseMenu">
            <i class="fa-solid fa-book"></i><span>Course</span>
            <i class="fas fa-chevron-down ms-auto"></i>
          </a>
          <div id="courseMenu" class="submenu">
            <a href="/course/manage"     class="nav-link">Manage Course</a>
          </div>
        </div>
        ...
        <div class="nav-group">
          ...
          <div id="examsMenu" class="submenu">
            <a href="/exam/add"     class="nav-link">Create Exam</a>
            <a href="/exam/manage"     class="nav-link">Manage Exams</a>

            <a href="/exam/result"    class="nav-link">Results</a>
          </div>
        </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', async () => {
      ...
      const logout = async () => {
        ...
        try {
          const token = localStorage.getItem('token') || sessionStorage.getItem('token');
          const res   = await fetch('/api/admin/logout',{ method:'POST', headers:{ 'Content-Type':'application/json','Authorization':`Bearer ${token}` } });
